<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Tambah Data Kandidat HMP-TI
		</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=data-calonti" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
if (isset($_POST['Simpan'])) {
	...
	if (!empty($sumber)) {
		$sql_simpan = "INSERT INTO tb_calonhmpti (id_calon, nama_calon, foto_calon, keterangan) VALUES (
        '" . $_POST['id_calon'] . "',
        '" . $_POST['nama_calon'] . "',
        '" . $nama_file . "',
        '" . $_POST['keterangan'] . "')";
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-calonti';
          }
      })</script>";
		} else {
			echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-calonti';
          }
      })</script>";
		}
	} elseif (empty($sumber)) {
