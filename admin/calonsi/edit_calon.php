...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Ubah Data Kandidat HMP-SI</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=data-calonsi" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
if (isset ($_POST['Ubah'])){
    ...
    if(!empty($sumber)){
        ...
        $sql_ubah = "UPDATE tb_calonhmpsi SET
